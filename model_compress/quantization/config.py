...
def get_parser(parser=None):
    ...
    parser.add_argument("--model", type=str, default="resnet50",
                        help="resnet50")
<<<<<<< HEAD
    parser.add_argument('--use_fp16', type=str2bool, nargs='?', const=True, help='Whether to use use fp16')
    parser.add_argument('--use_xla', type=str2bool, nargs='?', const=True, help='Whether to use xla')
    parser.add_argument('--use_tensorrt', type=str2bool, nargs='?', default=True, help='Whether to use tensorrt')
    parser.add_argument('--use_int8_online', type=str2bool, nargs='?', default=True,
=======
...
<<<<<<< HEAD
    ...
    parser.add_argument("--model_load_dir", type=str, default="/usr/local/model/resnet50",
